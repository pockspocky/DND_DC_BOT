...
class DiceCommands(commands.Cog):
    ...
    @app_commands.command(name="roll", description="投掷骰子")
    ...
    @app_commands.command(name="attack", description="攻击检定和伤害")
    @app_commands.describe(
        attack_bonus="攻击加值",
    ...
    @app_commands.command(name="rollhelp", description="显示骰子命令帮助")
